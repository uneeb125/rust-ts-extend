...
impl<'tcx> ThirBuildCx<'tcx> {
    ...
    pub(super) fn mirror_expr_inner(&mut self, hir_expr: &'tcx hir::Expr<'tcx>) -> ExprId {
        ...
        let compartment = expr.compartment.clone();
        expr = Expr {
    ...
    fn apply_adjustment(
        ...
        let kind = match adjustment.kind {
            ...
            Adjust::Deref(Some(deref)) => {
                ...
                let expr_ty = expr.ty;
                let _compartment = expr.compartment.clone();
                let arg_id = self.thir.exprs.push(expr);
                expr = Expr {
                    temp_lifetime,
                    ty: Ty::new_ref(self.tcx, self.tcx.lifetimes.re_erased, expr_ty, deref.mutbl),
                    span,
    ...
    fn capture_upvar(
        ...
        match upvar_capture {
            ...
            ty::UpvarCapture::ByUse => {
                ...
                let compartment = captured_place_expr.compartment.clone();
