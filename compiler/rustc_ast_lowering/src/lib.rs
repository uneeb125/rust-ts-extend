...
impl<'a, 'hir> LoweringContext<'a, 'hir> {
    ...
    fn lower_path_ty(
            ...
            && let Some(Res::Def(DefKind::Trait | DefKind::TraitAlias, _)) = partial_res.full_res()
        {
            ...
            return hir::Ty { kind, span: self.lower_span(t.span), hir_id: self.next_id(), compartments: &[] };
        }
    ...
    fn lower_ty_direct(&mut self, t: &Ty, itctx: ImplTraitContext) -> hir::Ty<'hir> {
        let kind = match &t.kind {
            ...
            TyKind::PinnedRef(region, mt) => {
                ...
                let arg = hir::Ty { kind, span, hir_id: self.next_id(), compartments: &[] };
    ...
    fn ty_path(&mut self, mut hir_id: HirId, span: Span, qpath: hir::QPath<'hir>) -> hir::Ty<'hir> {
        ...
        hir::Ty { hir_id, kind, span: self.lower_span(span), compartments: &[] }
    }
